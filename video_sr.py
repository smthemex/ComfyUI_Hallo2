...
def run_realesrgan(video_list,audio,frame_rate,model_path,hallo_model_path,fidelity_weight,input_path,output_path,upscale,has_aligned,only_center_face,draw_box,detection_model,bg_upsampler,face_upsample,bg_tile,parse_model,save_video,suffix=""):
    device = get_device()
